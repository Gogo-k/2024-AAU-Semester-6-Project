...
import org.dslul.openboard.inputmethod.keyboard.orangeBox.OrangeScript;

public final class InputView extends FrameLayout {
    private final Rect mInputViewRect = new Rect();
    private MainKeyboardView mMainKeyboardView;

    private OrangeScript mOrangeScript;
    ...
    protected void onFinishInflate() {
        ...
        mOrangeScript = findViewById(R.id.oragneBox);
        mKeyboardTopPaddingForwarder = new KeyboardTopPaddingForwarder(
                mMainKeyboardView, mOrangeScript);
        /*
    ...
    private static class KeyboardTopPaddingForwarder
            extends MotionEventForwarder<MainKeyboardView, OrangeScript> {
        private int mKeyboardTopPadding;

        public KeyboardTopPaddingForwarder(final MainKeyboardView mainKeyboardView,
                 final OrangeScript aaa) {
            super(mainKeyboardView, aaa);
        }
