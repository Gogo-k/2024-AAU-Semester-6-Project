...
import kotlinx.android.synthetic.main.main_keyboard_frame.view.oragneBox
...
class KeyboardWrapperView @JvmOverloads constructor(
    ...
    private lateinit var oragneBoy: View
    ...
    override fun onFinishInflate() {
        ...
        oragneBoy = findViewById(R.id.oragneBox)
        oragneBoy.oragneBox.setParent(this);
